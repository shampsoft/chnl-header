(function ($) {
    ...
    if ($("#loan-calculator").length) {
      ...
      var rateRange = document.getElementById("range-slider-rate");
      ...
      var limitFieldMinRate = document.getElementById(
        "min-value-rangeslider-rate"
      );
      var limitFieldMaxRate = document.getElementById(
        "max-value-rangeslider-rate"
      );
      ...
      monthRange.noUiSlider.on("update", function (values, handle) {
       ...
       /*rateRange.noUiSlider.on("update", function (values, handle) {
        (handle ? $(limitFieldMaxRate) : $(limitFieldMinRate)).attr(
          "value",
          values[handle]
        );
        let loanMoney = limitFieldMinCount.value;
